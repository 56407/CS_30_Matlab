classdef QuickerSimCFDToolboxApp < handle
    %
    % Usage:
    %     app.QuickerSimCFDToolboxApp
    ...
    properties (Constant)
        AppPathBase = {'/QuickerSimCFDToolbox/code'};
        AppClass = 'QuickerSimCFDToolboxApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = QuickerSimCFDToolboxApp()
        ...
        function startApp(obj)
            ...
            mlock;
            QuickerSimCFDToolboxApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Lite_Example1')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Lite_Example1
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Lite_Example1').getString, ...
            ...
            if nargout(@Lite_Example1) == 0
                eval('Lite_Example1');
            else
                obj.AppHandle = eval('Lite_Example1');
            end
