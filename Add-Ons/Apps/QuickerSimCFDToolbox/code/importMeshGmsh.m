function [p, e, t] = importMeshGmsh(fileName)

% importMeshGmsh - Read external mesh in Gmsh ASCII file format.
%
...
fd = fopen(fileName, 'r');
    ...
    if(dim == 2)
        ...
        for edge = 1:nedges
            ...
            el = intersect(elementsOfNode{n1}, elementsOfNode{n2});
            % Porownaj kierunek
        ...
        for face = 1:nfaces
            ...
            el = intersect(intersect(elementsOfNode{n1}, elementsOfNode{n2}),elementsOfNode{n3});
